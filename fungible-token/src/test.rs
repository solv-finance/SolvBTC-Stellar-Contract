...
fn test_minter_management_and_mint_flow() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "remove_minter_by_manager",
            args: (&minter,).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_burn_blacklisted_tokens_by_admin() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "mint_from",
            args: (&minter, &blacklisted, &100i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "add_to_blacklist",
            args: (&owner, &blacklisted).into_val(&env),
            sub_invokes: &[],
        },
    }]);
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "burn_blacklisted_tokens_by_admin",
            args: (&blacklisted,).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_blacklist_scenario() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "mint_from",
            args: (&minter, &a, &100i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_multiple_blacklist_operations() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "mint_from",
            args: (&minter, &a, &50i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "mint_from",
            args: (&minter, &b, &30i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_admin_functions() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            ...
            args: (&new_admin, &live_until).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_add_to_blacklist_unauthorized_should_panic() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "add_to_blacklist",
            args: (&not_owner, &user).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_transfer_to_blacklisted_recipient_should_panic() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "mint_from",
            args: (&minter, &user, &10i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "add_to_blacklist",
            args: (&owner, &recipient).into_val(&env),
            sub_invokes: &[],
        },
    }]);
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "transfer",
            args: (&user, &recipient, &1i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_transfer_from_with_blacklisted_spender_should_panic() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "approve",
            args: (&user, &spender, &5i128, &live).into_val(&env),
            sub_invokes: &[],
        },
    }]);
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            ...
            args: (&spender, &user, &owner, &1i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_burn_from_with_allowance() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "mint_from",
            args: (&minter, &user, &20i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "approve",
            args: (&user, &spender, &7i128, &live).into_val(&env),
            sub_invokes: &[],
        },
    }]);
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "burn_from",
            args: (&spender, &user, &7i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_burn_blacklisted_tokens_by_admin_not_blacklisted_should_panic() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "mint_from",
            args: (&minter, &a, &10i128).into_val(&env),
            sub_invokes: &[],
        },
    }]);
...
fn test_mint_from_negative_amount_should_panic() {
    ...
    env.mock_auths(&[MockAuth {
        ...
        invoke: &MockAuthInvoke {
            contract: &client.address,
            fn_name: "mint_from",
            args: (&minter, &user, &(-1i128)).into_val(&env),
            sub_invokes: &[],
        },
    }]);
