...
export type DataKey = {
    ...
    tag: "MintAuthorization";
    values: void;
};
export type BlacklistDataKey = {
    tag: "BlackListAddress";
...
export interface Client {
     ...
     */
    initialize: ({ admin, name, symbol, decimals, mint_authorization }: {
        admin: string;
        name: string;
        symbol: string;
        decimals: u32;
     ...
     */
    transfer_mint_authorization: ({ new_mint_authorization }: {
        new_mint_authorization: string;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
         */
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        add_to_blacklist: (json: string) => AssembledTransaction<null>;
        remove_from_blacklist: (json: string) => AssembledTransaction<null>;
        is_blacklisted: (json: string) => AssembledTransaction<boolean>;
        admin: (json: string) => AssembledTransaction<Option<string>>;
        transfer_admin: (json: string) => AssembledTransaction<null>;
        transfer_mint_authorization: (json: string) => AssembledTransaction<null>;
        mint_authorization: (json: string) => AssembledTransaction<Option<string>>;
    };
}
