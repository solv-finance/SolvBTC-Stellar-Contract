...
export interface Client {
     ...
     * Initialize contract
     */
    initialize: ({ admin, nav_decimals, initial_nav, max_change_percent }: {
        admin: string;
        nav_decimals: u32;
        initial_nav: i128;
     ...
     */
    set_nav_manager_by_admin: ({ manager_address }: {
     ...
     */
    set_max_nav_change_by_admin: ({ max_change_percent }: {
        max_change_percent: u32;
    }, options?: {
        /**
         * The fee to pay for the transaction. Default: BASE_FEE
     ...
     */
    emit_initialization_event: ({ admin, initial_nav, nav_decimals, max_change_percent }: {
        admin: string;
        initial_nav: i128;
        nav_decimals: u32;
        max_change_percent: u32;
     ...
     */
    emit_nav_manager_set_event: ({ admin, nav_manager }: {
        admin: string;
        nav_manager: string;
    }, options?: {
        /**
     ...
     */
    emit_max_change_updated_event: ({ admin, max_change_percent }: {
        admin: string;
        max_change_percent: u32;
    }, options?: {
        /**
     ...
     */
    emit_nav_updated_event: ({ nav_manager, old_nav, new_nav }: {
        nav_manager: string;
        old_nav: i128;
        new_nav: i128;
    }, options?: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        get_nav: (json: string) => AssembledTransaction<bigint>;
        get_nav_decimals: (json: string) => AssembledTransaction<number>;
        max_nav_change_percent: (json: string) => AssembledTransaction<number>;
        admin: (json: string) => AssembledTransaction<string>;
        set_nav_manager_by_admin: (json: string) => AssembledTransaction<null>;
        set_max_nav_change_by_admin: (json: string) => AssembledTransaction<null>;
        nav_manager: (json: string) => AssembledTransaction<Option<string>>;
        set_nav_by_manager: (json: string) => AssembledTransaction<null>;
        emit_initialization_event: (json: string) => AssembledTransaction<null>;
        emit_nav_manager_set_event: (json: string) => AssembledTransaction<null>;
        emit_max_change_updated_event: (json: string) => AssembledTransaction<null>;
        emit_nav_updated_event: (json: string) => AssembledTransaction<null>;
    };
}
