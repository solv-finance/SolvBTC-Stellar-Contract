...
export declare const MinterManagerError: {
    1: {
        message: string;
    };
    2: {
...
export interface Client {
     ...
     */
    mint: ({ from, token_contract, to, amount }: {
        from: string;
        token_contract: string;
        to: string;
        amount: i128;
     ...
     */
    burn: ({ from, token_contract, amount }: {
        from: string;
        token_contract: string;
        amount: i128;
    }, options?: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        add_minter_by_admin: (json: string) => AssembledTransaction<null>;
        remove_minter_by_admin: (json: string) => AssembledTransaction<null>;
        get_minters: (json: string) => AssembledTransaction<string[]>;
        is_minter: (json: string) => AssembledTransaction<boolean>;
        mint: (json: string) => AssembledTransaction<null>;
        burn: (json: string) => AssembledTransaction<null>;
        token_contract: (json: string) => AssembledTransaction<string>;
    };
}
